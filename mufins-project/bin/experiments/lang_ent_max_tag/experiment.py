...
'''
lang_ent_max_tag experiment.
'''

import os
import argparse
from mufins.experiments.lang_ent_max_tag.experiment import (
    LangEntMaxTagParameterSpace, lang_ent_max_tag_experiment,
)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Run the experiment coded lang_ent_max_tag.'
    )
    parser.add_argument(
        '--label_src_path',
        required=True,
    ...
    parser.add_argument(
        '--default_lang_error_weighting',
        required=True,
        type=float,
        help=(
            'The weighting to use when adding together the language and label errors.'
            ' The language error is multiplied by lang_error_weighting whilst'
    ...
    lang_ent_max_tag_experiment(
        ...
        parameter_space=LangEntMaxTagParameterSpace(
            ...
            lang_error_weighting=args.default_lang_error_weighting,
