...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Run the experiment coded lang_grad_rev_cls.'
    )
    parser.add_argument(
        '--label_src_path',
        required=True,
    ...
    parser.add_argument(
        ...
        required=True,
        type=float,
        help='The lambda weighting to use for the gradient reversal layer.'
    )
    parser.add_argument(
        '--default_patience',
        required=False,
    ...
    lang_grad_rev_cls_experiment(
        ...
        parameter_space=LangGradRevClsParameterSpace(
            ...
            grl_lambda=args.default_grl_lambda,
