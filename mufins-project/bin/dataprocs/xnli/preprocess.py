...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Preprocess the XNLI dataset.'
    )
    parser.add_argument(
        '--src_path_xnli',
        required=True,
        help='The path to the raw XNLI dataset.'
    )
    parser.add_argument(
        '--src_path_multinli',
        required=True,
        help='The path to the raw multi NLI dataset.'
    )
    parser.add_argument(
        '--dst_path',
        required=True,
    ...
    xnli_preprocess(
        src_path_xnli=os.path.abspath(args.src_path_xnli),
        src_path_multinli=os.path.abspath(args.src_path_multinli),
