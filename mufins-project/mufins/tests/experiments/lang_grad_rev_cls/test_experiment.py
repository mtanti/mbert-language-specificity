'''
Unit test for lang_grad_rev_cls Experiment function in lang_grad_rev_cls module.
'''
...
from mufins.experiments.lang_grad_rev_cls.experiment import (
    LangGradRevClsParameterSpace, lang_grad_rev_cls_experiment,
)
...
#########################################
class TestLangGradRevClsExperiment(unittest.TestCase):
    '''
    Unit test class.
    '''
    ...
    def test_(
        ...
        '''
        Test the lang_grad_rev_cls_experiment function.
        '''
        with tempfile.TemporaryDirectory() as path:
            ...
            for exp_id in os.listdir(os.path.join(path, 'dst', 'results')):
                model = LangGradRevClsModel.load_model(
