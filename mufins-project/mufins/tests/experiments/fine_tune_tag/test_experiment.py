...
from mufins.experiments.fine_tune_tag.experiment import (
    FineTuneTagParameterSpace, fine_tune_tag_experiment,
)
    ...
    def test_(
        ...
        with tempfile.TemporaryDirectory() as path:
            ...
            for exp_id in os.listdir(os.path.join(path, 'dst', 'results')):
                model = FineTuneTagModel.load_model(
