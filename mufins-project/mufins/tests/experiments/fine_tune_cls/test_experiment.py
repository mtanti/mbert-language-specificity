'''
Unit test for fine_tune_cls Experiment function in fine_tune_cls module.
'''
...
#########################################
class TestFineTuneClsExperiment(unittest.TestCase):
    '''
    Unit test class.
    '''
    ...
    def test_(
        ...
        '''
        Test the fine_tune_cls_experiment function.
        '''
        with tempfile.TemporaryDirectory() as path:
            ...
            for exp_id in os.listdir(os.path.join(path, 'dst', 'results')):
                model = FineTuneClsModel.load_model(
