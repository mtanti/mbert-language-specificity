'''
Unit test for lang_ent_max_tag Experiment function in lang_ent_max_tag module.
'''
...
#########################################
class TestLangEntMaxTagExperiment(unittest.TestCase):
    '''
    Unit test class.
    '''
    ...
    def test_(
        ...
        '''
        Test the lang_ent_max_tag_experiment function.
        '''
        with tempfile.TemporaryDirectory() as path:
            ...
            for exp_id in os.listdir(os.path.join(path, 'dst', 'results')):
                model = LangEntMaxTagModel.load_model(
