'''
Run experiment with ID: fine_tune_tag
'''
...
from mufins.experiments.fine_tune_tag.hyperparameters import FineTuneTagParameterSpace
from mufins.experiments.fine_tune_tag.model import FineTuneTagModel
from mufins.experiments.fine_tune_tag.evaluate import (
...
#########################################
def fine_tune_tag_experiment(
    label_src_path: str,
    lang_src_path: str,
    dst_path: str,
    device_name: str,
    parameter_space: FineTuneTagParameterSpace,
    hyperparameter_search_mode: bool,
    batch_size: int,
    seed: Optional[int],
    verbose: bool = True,
    ...
    try:
        ...
        with Timer() as overall_timer:
            log.log_message('')
            log.log_message('------------------------------------------------')
            log.log_message('Running fine_tune_tag experiment.')
            log.log_message('')
