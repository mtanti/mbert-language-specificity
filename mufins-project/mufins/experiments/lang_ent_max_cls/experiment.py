'''
Run experiment with ID: lang_ent_max_cls
'''
...
from mufins.dataprocs.wikipedia.preprocess import DATASET_VERSION as WIKIPEDIA_DATASET_VERSION
...
from mufins.experiments.lang_ent_max_cls.hyperparameters import LangEntMaxClsParameterSpace
...
#########################################
def lang_ent_max_cls_experiment(
    label_src_path: str,
    lang_src_path: str,
    dst_path: str,
    device_name: str,
    ...
    '''
    Run experiment lang_ent_max_cls.
    ...
    try:
        ...
        with Timer() as overall_timer:
            log.log_message('')
            log.log_message('------------------------------------------------')
            log.log_message('Running lang_ent_max_cls experiment.')
            log.log_message('')
            ...
            version_file.init()
            if WIKIPEDIA_DATASET_VERSION != version_file.read():
