...
class Hyperparameters():
    ...
    def __init__(
        ...
        :param lang_error_weighting: The weighting to use when adding together the language
            and label errors. The language error is multiplied by lang_error_weighting whilst
            the label error is multiplied by (1 - lang_error_weighting).
        ...
        if lang_error_weighting < 0.0:
            raise ValueError('Invalid language error weighting.')
        self.lang_error_weighting: float = lang_error_weighting
    ...
    def to_json(
        ...
        return json.dumps(dict(
            ...
            lang_error_weighting=self.lang_error_weighting,
    ...
    def from_json(
        ...
        if not isinstance(params['lang_error_weighting'], (float,)):
            raise ValueError('Invalid language error weighting type.')
        ...
        return Hyperparameters(
            ...
            lang_error_weighting=params['lang_error_weighting'],
...
#########################################
class LangEntMaxClsParameterSpace(ParameterSpace[Hyperparameters]):
    '''
    lang_ent_max_cls parameter space class.
    '''
    ...
    def __init__(
        ...
        :param lang_error_weighting: The weighting to use when adding together the language
            and label errors. The language error is multiplied by lang_error_weighting whilst
            the label error is multiplied by (1 - lang_error_weighting).
            If None then validation checks will happen after each epoch.
        ...
        super().__init__(
            dict(
                ...
                lang_error_weighting=lang_error_weighting,
                patience=patience,
