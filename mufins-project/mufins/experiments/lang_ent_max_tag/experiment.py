'''
Run experiment with ID: lang_ent_max_tag
'''
...
from mufins.experiments.lang_ent_max_tag.hyperparameters import LangEntMaxTagParameterSpace
from mufins.experiments.lang_ent_max_tag.model import LangEntMaxTagModel
...
#########################################
def lang_ent_max_tag_experiment(
    label_src_path: str,
    lang_src_path: str,
    dst_path: str,
    device_name: str,
    ...
    '''
    Run experiment lang_ent_max_tag.
    ...
    try:
        ...
        with Timer() as overall_timer:
            log.log_message('')
            log.log_message('------------------------------------------------')
            log.log_message('Running lang_ent_max_tag experiment.')
            log.log_message('')
