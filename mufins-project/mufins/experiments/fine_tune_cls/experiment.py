'''
Run experiment with ID: fine_tune_cls
'''
...
from mufins.experiments.fine_tune_cls.hyperparameters import (
    FineTuneClsParameterSpace
)
from mufins.experiments.fine_tune_cls.model import FineTuneClsModel
from mufins.experiments.fine_tune_cls.evaluate import (
...
def fine_tune_cls_experiment(
    ...
    try:
        ...
        with Timer() as overall_timer:
            log.log_message('')
            log.log_message('------------------------------------------------')
            log.log_message('Running fine_tune_cls experiment.')
            log.log_message('')
