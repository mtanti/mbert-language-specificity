...
from mufins.experiments.fine_tune_cls.hyperparameters import Hyperparameters
from mufins.experiments.fine_tune_cls.training_process import ModelTrainingProcess
...
#########################################
class FineTuneClsModel(ModelStandard):
    '''
    The model class.
    '''
