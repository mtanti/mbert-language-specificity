...
class Hyperparameters():
    ...
    def __init__(
        ...
        :param grl_lambda: The lambda constant to multiply the gradient in the
    ...
    def from_json(
        ...
        if not isinstance(params['grl_lambda'], (float,)):
            raise ValueError('Invalid gradient reversal layer lambda type.')
...
#########################################
class LangGradRevTagParameterSpace(ParameterSpace[Hyperparameters]):
    '''
    lang_grad_rev_tag parameter space class.
    '''
    ...
    def __init__(
        ...
        :param grl_lambda: The lambda weighting to use for the gradient reversal
            layer.
