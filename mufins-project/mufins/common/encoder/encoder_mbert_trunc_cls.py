'''
Class for encoding text using truncated m-BERT with CLS token being used to encode text.
'''
...
#########################################
class EncoderMbertTruncCls(Encoder):
    '''
    Truncated m-BERT encoder with text encoder using CLS method.
    '''
    ...
    def forward(
        ...
        return (
            ...
            hidden_layers[self.layer_index][:, 0, :], # CLS token is at index 0.
        )
